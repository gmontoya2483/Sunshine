...
// 60 seconds (1 minute)  180 = 3 hours
    ...
    //Add the the anotations dependencies first!!!!
        ...
        try {
            ...
            */
            ...
            if (buffer.length() == 0) {
                ...
                // Assume the server status is down as nothing was retrieved
            ...
            // to parse it.
            // Assume the server status is down as got an exception
            setLocationStatus(getContext(),LOCATION_STATUS_SERVER_DOWN);
        } catch (JSONException e) {
            Log.e(LOG_TAG, e.getMessage(), e);
            e.printStackTrace();
            // Assume the server status is invalid if there is an excpetion parsing the JSON
     ...
     * the UI thread beacause it uses commit to write the shared preferences.
     *
